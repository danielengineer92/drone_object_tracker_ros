...
safe to publish `/drone/autonomy/enabled` and `/drone/mavsdk/offboard_enable`. MAVSDK Offboard now also requires an operator request on `/drone/mavsdk/offboard_request`.

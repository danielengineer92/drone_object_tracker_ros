...
| `/drone/mavsdk/offboard_enable` | `std_msgs/msg/Bool` | Second hard gate for actual MAVSDK/PX4 command sending |
...
```bash
ros2 topic pub --once /drone/mavsdk/offboard_enable std_msgs/msg/Bool "{data: true}"
```

Disable actual PX4 command sending:

```bash
ros2 topic pub --once /drone/mavsdk/offboard_enable std_msgs/msg/Bool "{data: false}"
```
